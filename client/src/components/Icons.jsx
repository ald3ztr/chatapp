// SVG ikon seti (FAZ 3 tasarim rotusu)
// Tum arayuz ikonlari burada; emoji yerine cizgi-tabanli (lucide tarzi) ikonlar.

function Svg({ size = 24, className = '', filled = false, children }) {
  return (
    <svg
      width={size}
      height={size}
